...
c  ordinary decay
     ...
     *           .or.ityptl(i).eq.42.or.ityptl(i).eq.52
     *           .or.ityptl(i).eq.53
     *           .or.(ityptl(i).eq.43.and..not.(abs(idproj).lt.200
     *                                 .and.pptl(5,ioi).lt.2.75))))then
c mix rho and omegas only from string production (with remnant string mass high enough not to be low mass diffraction (fine tuning from NA22) and if not decay product
...
c-----------------------------------------------------------------------
     ...
     *, 111., .99988, 120.,-120.,   0.,   0.,   0.
     *, 111., .99992,  12., -12.,   0.,   0.,   0.
     *, 111., .99996,  14., -14.,   0.,   0.,   0.
     *, 111.,1.00000, 110., 110.,  10.,   0.,   0.
     *, 221., .89200, 120.,-120., 110.,   0.,   0.
     *, 221., .90700, 120.,-120.,   0.,   0.,   0./
      data ((dectab(i,j),i=1,7),j= 20, 38)/
     *  221., .99982, 110.,  10.,   0.,   0.,   0.
     *, 221., .99990,  12., -12.,   0.,   0.,   0.
     *, 221.,1.00000,  14., -14.,   0.,   0.,   0.
     ...
     *, 441., .15210,-121., 120.,   0.,   0.,   0./
      data ((dectab(i,j),i=1,7),j= 93,110)/
     ...
     *, 150., .27000, -16.,  15., 141.,   0.,   0./
      data ((dectab(i,j),i=1,7),j=111,124)/
     ...
     *, 150., 0.995  ,   1.,  -1.,   1.,  -2.,   0.
     *, 150., 1.     ,   1.,  -1.,   4.,  -3.,   0./
      data ((dectab(i,j),i=1,7),j=125,144)
     ...
     *, 250., 0.995  ,   2.,  -1.,   1.,  -2.,   0.
     *, 250., 1.     ,   2.,  -1.,   4.,  -3.,   0./
      data ((dectab(i,j),i=1,7),j=145,176)/
     *     224*1. /
